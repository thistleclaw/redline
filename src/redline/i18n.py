...
TEXT: dict[str, dict[str, str]] = {
    ...
    "rd.heading": {
        "ru": "R&D BLUEPRINT // подтверждённые артефакты",
        "en": "R&D BLUEPRINT // verified artifacts",
    },
    "selected.actions": {
    ...
    "sync.done": {
        "ru": "SYNC // новых событий: {events}; новых alert: {alerts}",
        "en": "SYNC // new events: {events}; new alerts: {alerts}",
    },
