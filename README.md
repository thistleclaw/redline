...
`:test ai model` — гибридный режим: Gemini выбирает только входные гипотезы и географические
узлы, после строгой проверки весь временной ряд рассчитывает локальный NumPy-движок. Он расширяет
